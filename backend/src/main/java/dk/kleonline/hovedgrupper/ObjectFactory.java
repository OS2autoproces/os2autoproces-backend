 ...
 * generated in the dk.kleonline.hovedgrupper package. 
...
public class ObjectFactory {
    ...
    private final static QName _Hovedgruppe_QNAME = new QName("http://www.kle-online.dk/rest/resources/hovedgruppe/liste", "Hovedgruppe");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dk.kleonline.hovedgrupper
     * 
     */
    ...
    /**
     * Create an instance of {@link HovedgruppeType }
     * 
     */
    public HovedgruppeType createHovedgruppeType() {
        return new HovedgruppeType();
    }

    /**
     * Create an instance of {@link KLEHovedgrupper }
     * 
     */
    public KLEHovedgrupper createKLEHovedgrupper() {
        return new KLEHovedgrupper();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link HovedgruppeType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.kle-online.dk/rest/resources/hovedgruppe/liste", name = "Hovedgruppe")
    public JAXBElement<HovedgruppeType> createHovedgruppe(HovedgruppeType value) {
        return new JAXBElement<HovedgruppeType>(_Hovedgruppe_QNAME, HovedgruppeType.class, null, value);
    }
