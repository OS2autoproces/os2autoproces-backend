 ...
 * generated in the dk.kleonline.grupper package. 
...
public class ObjectFactory {
    ...
    private final static QName _Gruppe_QNAME = new QName("http://www.kle-online.dk/rest/resources/gruppe/liste", "Gruppe");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dk.kleonline.grupper
     * 
     */
    ...
    /**
     * Create an instance of {@link KLEGrupper }
     * 
     */
    public KLEGrupper createKLEGrupper() {
        return new KLEGrupper();
    }

    /**
     * Create an instance of {@link GruppeType }
     * 
     */
    public GruppeType createGruppeType() {
        return new GruppeType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GruppeType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.kle-online.dk/rest/resources/gruppe/liste", name = "Gruppe")
    public JAXBElement<GruppeType> createGruppe(GruppeType value) {
        return new JAXBElement<GruppeType>(_Gruppe_QNAME, GruppeType.class, null, value);
    }
